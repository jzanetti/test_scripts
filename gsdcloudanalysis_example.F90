...
!
           ...
           call write_gsdcloud_debug('ref_inputs.nc', nmsclvl_radar, lat2, lon2, &
                                'r_kind', ref_mosaic31, ref_mosaic31, ref_mosaic31)
           istat_radar=1
...
!
  ...
  call write_gsdcloud_debug('background_cloud_water_and_ice.nc', nsig, lat2, lon2, &
                                'r_kind', sumqci, sumqci, sumqci)
...
!          
  ...
  call write_gsdcloud_debug('background_derived_temperature.nc', nsig, lat2, lon2, &
                                'r_single', t_bk, t_bk, t_bk)
...
!
  if(istat_radar ==  1 ) then
     ...
     call write_gsdcloud_debug('ref_at_analysis_grid.nc', nsig, lat2, lon2, 'r_kind', ref_mos_3d, ref_mos_3d, ref_mos_3d)
...
!
  ...
  call write_gsdcloud_debug('cld_cover_3d_after_42.nc', nsig, lat2, lon2, 'r_single', cld_cover_3d, cld_cover_3d, cld_cover_3d)
  call write_gsdcloud_debug('cld_type_3d_after_42.nc', nsig, lat2, lon2, 'i_kind', cld_type_3d, cld_type_3d, cld_type_3d)
...
!
  ...
  call write_gsdcloud_debug('cld_type_3d_after_44.nc', nsig, lat2, lon2, 'i_kind', cld_type_3d, cld_type_3d, cld_type_3d)
  call write_gsdcloud_debug('cld_cover_3d_after_44.nc', nsig, lat2, lon2, 'r_single', cld_cover_3d, cld_cover_3d, cld_cover_3d)
...
!
  if(opt_cloudwaterice_retri == 1 ) then
     call write_gsdcloud_debug('cldwater_3d_before_46.nc', nsig, lat2, lon2, 'r_single', cldwater_3d, cldwater_3d, cldwater_3d)
     call cloudLWC_stratiform(mype,lat2,lon2,nsig,q_bk,t_bk,p_bk,      &
                  cld_cover_3d,cld_type_3d,wthr_type_2d,cloudlayers_i, &
                  cldwater_3d,cldice_3d)
     call write_gsdcloud_debug('cldwater_3d_after_46.nc', nsig, lat2, lon2, 'r_single', cldwater_3d, cldwater_3d, cldwater_3d)
     if(mype==0) write(6,*) 'gsdcloudanalysis: ',                      &
...
!
  ...
  if(istat_radar == 1 .or. istat_lightning == 1) then
     ...
     !call write_gsdcloud_debug('pcp_type_3d_before_48.nc', nsig, lat2, lon2, 'i_kind', pcp_type_3d, pcp_type_3d, pcp_type_3d)
     call PrecipType(lat2,lon2,nsig,t_bk,p_bk,q_bk,ref_mos_3d,         &
                    wthr_type_2d,pcp_type_3d)
     if(mype==0) write(6,*) 'gsdcloudanalysis: ',                      &
                 ' success in deciding precipitation type'
     call write_gsdcloud_debug('pcp_type_3d_after_48.nc', nsig, lat2, lon2, 'i_kind', pcp_type_3d, pcp_type_3d, pcp_type_3d)


     call write_gsdcloud_debug('rain_3d_before_48.nc', nsig, lat2, lon2, 'r_single', rain_3d, rain_3d, rain_3d)
     ...
     call write_gsdcloud_debug('rain_3d_after_48.nc', nsig, lat2, lon2, 'r_single', rain_3d, rain_3d, rain_3d)
...
!
  ...
  if (istat_nesdis==1) then
     ...
     call write_gsdcloud_debug('ref_mos_3d_tten_before_410.nc', nsig, lat2, lon2, 'r_kind', ref_mos_3d_tten, ref_mos_3d_tten,ref_mos_3d_tten)
     call write_gsdcloud_debug('cld_cover_3d_before_410.nc', nsig, lat2, lon2, 'r_single', cld_cover_3d, cld_cover_3d, cld_cover_3d)
     ...
     call write_gsdcloud_debug('ref_mos_3d_tten_after_410.nc', nsig, lat2, lon2, 'r_kind', ref_mos_3d_tten, ref_mos_3d_tten,ref_mos_3d_tten)
     call write_gsdcloud_debug('cld_cover_3d_after_410.nc', nsig, lat2, lon2, 'r_single', cld_cover_3d, cld_cover_3d, cld_cover_3d)
  endif
...
call write_gsdcloud_debug('cldwater_3d_after_5.nc', nsig, lat2, lon2, 'r_single', cldwater_3d, cldwater_3d, cldwater_3d)
...
call write_gsdcloud_debug('cldwater_3d_last.nc', nsig, lat2, lon2, 'r_single', cldwater_3d, cldwater_3d, cldwater_3d)
